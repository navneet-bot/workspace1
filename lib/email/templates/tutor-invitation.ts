export interface TutorInvitationParams {
  tutorName: string;
  tutorEmail: string;
...
export function buildTutorInvitationEmail({
  tutorName,
  tutorEmail,
  generatedPassword,
  companyName = "Job Jockey",
  supportEmail = "admin@jobjockey.in",
}: TutorInvitationParams): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <div class="email-wrapper">
    ...
    <div class="content">
      ...
      <p>Your tutor profile has been <strong style="color: #10b981;">approved & onboarded</strong>. We are thrilled to have you join our verified educator network.</p>
      ...
      <div class="card">
        ...
        <div class="credential-group">
          ...
          <span class="credential-value">📧 ${tutorEmail}</span>
        </div>
